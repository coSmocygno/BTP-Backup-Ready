...
@EndUserText.label: 'Consumption Booking View - unmanaged'
@Metadata.ignorePropagatedAnnotations: true
@Metadata.allowExtensions: true
define view entity Z_C_BOOKING_U 
as projection on Z_I_BOOKING_U
{
...
//      LastChangedAt,
      /* Associations */
      ///DMO/I_Booking_U
      _Travel: redirected to parent Z_C_TRAVEL_U,
