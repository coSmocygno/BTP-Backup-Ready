CLASS lsc_Z_I_TRAVEL_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_Z_I_TRAVEL_U IMPLEMENTATION.
  ...
  "This method is the heart of Late Numbering in an Unmanaged RAP scenario.
"It handles the moment when the "Preliminary" IDs (temporary IDs used during
"the draft/session) are replaced by the "Final" IDs generated by the database/
"legacy Function Module during the save sequence.
